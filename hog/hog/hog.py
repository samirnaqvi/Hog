...
def free_bacon(score):
    ...
    if(score<10):
        ...
        first_digit=(score//10)%10
        second_digit=score%10
    baconscore= 1 + max(first_digit,second_digit)
    return baconscore
    "*** REPLACE THIS LINE ***"
    # END PROBLEM 2
        ...
        if who==0:
            ...
            if score0-previous_score > previous_high:
                ...
                if score0-previous_score==1:
                    print(str(score0-previous_score)+" point! That's the biggest gain yet for Player 0")
                else:
                    print(str(score0-previous_score)+" points! That's the biggest gain yet for Player 0")
            ...
            if score1-previous_score > previous_high:
                ...
                if score1-previous_score==1:
                    print(str(score1-previous_score)+" point! That's the biggest gain yet for Player 1")
                else:
                    print(str(score1-previous_score)+" points! That's the biggest gain yet for Player 1")
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    while(current_dice_number<=10):
        averaged_dice=make_averaged(roll_dice)(current_dice_number,dice)
        """temp=averaged_dice()"""
        """print(temp)"""
        if(averaged_dice>currenthigh):
            currenthigh=averaged_dice
            number_of_dice=current_dice_number
        current_dice_number=current_dice_number+1
